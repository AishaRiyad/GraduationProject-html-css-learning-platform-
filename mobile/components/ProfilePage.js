...
import LessonProgressMobile from "./LessonProgressMobile";
import TasksTabMobile from "./TasksTabMobile";
import CertificatesTabMobile from "./CertificatesTabMobile";
const API = "http://10.0.2.2:5000";

export default function ProfilePageMobile({ token }) {
